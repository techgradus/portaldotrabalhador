...
const initialMessage: Message = {
  id: '0',
  role: 'assistant',
  text: 'Olá! Sou o Gui, seu guia trabalhista. Estou aqui para tirar suas dúvidas sobre a CLT, direitos trabalhistas e muito mais. Como posso ajudar?',
  timestamp: new Date(),
};
...
export default function ChatBot() {
  ...
  useEffect(() => {
    try {
      ...
      // O chat continua funcionando mesmo se o navegador bloquear armazenamento local.
    }
  }, [messages, sessionId]);
