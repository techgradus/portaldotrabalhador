...
const leis = [
  { slug: 'direitos-clt', titulo: 'Direitos do Trabalhador na CLT', cat: 'Direitos Básicos', tempo: '8 min', resumo: 'Conheça os principais direitos garantidos pela CLT, do registro em carteira às verbas rescisórias.' },
  ...
  { slug: 'seguro-desemprego', titulo: 'Seguro-Desemprego: quem tem direito', cat: 'FGTS', tempo: '5 min', resumo: 'O seguro-desemprego é pago ao trabalhador dispensado sem justa causa. Conheça os requisitos.' },
  ...
  { slug: 'fgts-direitos', titulo: 'FGTS: depósito, saque e multa', cat: 'FGTS', tempo: '7 min', resumo: 'O empregador deposita mensalmente 8% do salário no FGTS. Saiba quando você pode sacar.' },
