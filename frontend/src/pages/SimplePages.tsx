...
const noticias = [
  { titulo: 'Novas regras para o trabalho remoto em 2025', data: '15/03/2025', cat: 'Trabalho Remoto', resumo: 'A regulamentação do teletrabalho foi atualizada com obrigações claras sobre despesas, jornada e controle de saúde ocupacional.' },
  { titulo: 'Salário mínimo 2025: reajuste e impactos', data: '01/01/2025', cat: 'Salário', resumo: 'O salário mínimo foi reajustado para R$ 1.518,00, com reflexos em benefícios como INSS, PIS e seguro-desemprego.' },
  { titulo: 'Mudanças na tabela do INSS para 2025', data: '01/01/2025', cat: 'Previdência', resumo: 'As faixas de contribuição ao INSS foram atualizadas. Saiba qual alíquota se aplica ao seu salário.' },
